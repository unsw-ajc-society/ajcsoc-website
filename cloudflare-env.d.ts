/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv ./cloudflare-env.d.ts` (hash: 6cf5a48cfcc0c29bc8aec26a5453fafe)
// Runtime types generated with workerd@1.20250604.0 2025-06-17 global_fetch_strictly_public,nodejs_compat
declare namespace Cloudflare {
	interface Env {
		NEXTJS_ENV: string;
		GOOGLE_SERVICE_ACCOUNT_EMAIL: string;
		GOOGLE_SERVICE_ACCOUNT_PRIVATE_KEY: string;
		NEWSLETTER_SUBSCRIPTION_SHEET_ID: string;
		NEWSLETTER_SUBSCRIPTION_SHEET_RANGE: string;
		ASSETS: Fetcher;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "NEXTJS_ENV" | "GOOGLE_SERVICE_ACCOUNT_EMAIL" | "GOOGLE_SERVICE_ACCOUNT_PRIVATE_KEY" | "NEWSLETTER_SUBSCRIPTION_SHEET_ID" | "NEWSLETTER_SUBSCRIPTION_SHEET_RANGE">> {}
}
